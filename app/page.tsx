...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-cover bg-center p-6 md:p-8 bg-[url('/background.png')] 
    dark:bg-[url('/background_dark.png')]">
      <div className="mx-auto max-w-7xl space-y-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold">BNBIntent</h1>
            <p className="font-sans font-normal leading-[28px] text-[#434343] dark:text-foreground">Your intelligent BNB crypto portfolio manager</p>
          </div>
          <ConnectWallet />
        </div>
        <Card className='bg-[rgba(251,251,251,0.30)] dark:bg-[rgba(55,55,55,0.30)]'>
          ...
          <Tabs defaultValue="ai" className="w-full my-2">
            ...
            <TabsContent value="ai">
              <div className="grid gap-6 md:grid-cols-2">
                <Card className="space-y-6 dark:bg-[rgba(55,55,55,0.30)]">
