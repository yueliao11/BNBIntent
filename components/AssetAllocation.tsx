...
export function AssetAllocation({
  ...
  const render = () => {
    ...
    return (
      error ? (
        ...
        <div className="space-y-6 max-h-[500px] overflow-y-auto p-5">
          {assets.map((asset) => (
            <Card
              key={asset.symbol}
              className="p-4 rounded-[2.5rem] bg-[unset] border-4 border-white shadow-[0px_4px_25.7px_0px_rgba(153,153,153,0.13)] backdrop-blur-[5px]
              dark:bg-[rgba(35,35,35,0.60)]"
            >
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-4 min-w-[100px]">
                  ...
                  <div>
                    <h3 className="font-semibold" style={{ fontFamily: "PingFang SC" }}>{asset.name}</h3>
                    <div className="flex items-center space-x-2 text-base text-[#6D6C6C]">
                ...
                <div className="text-right min-w-[60px]">
                  <p className="text-2xl font-semibold">
                    <span>$</span><span className="text-[#2C4BF5] dark:text-[#9DFAFF]">{(asset.price || 0).toFixed(2)}</span>
                  </p>
  ...
  return (
    <Card className="p-12 dark:shadow-[0px_4px_25.7px_0px_rgba(0,0,0,0.3)] dark:border-[rgba(55,55,55,0.65)] dark:border-2 dark:bg-[rgba(55,55,55,0.30)]">
      <div className="font-[700] text-xl leading-[37px] text-[#0F0F0F] dark:text-foreground font-sans mb-4">
