...
export function WalletOverview() {
  ...
  return (
    <Card className="p-12 dark:bg-[url('/card_dark.jpg')] dark:bg-cover">
      <div className="space-y-1">
        <div className="flex items-center gap-2">
          <div className="font-[700] text-xl leading-[37px] text-[#0F0F0F] dark:text-foreground font-sans">
            {t('asset.allocation.value')}
          </div>

        </div>
        <div className="text-3xl font-bold">
          <span className="text-[#000000] dark:text-foreground">$</span>{" "}<span className="text-[#2C4BF5]  dark:text-foreground">{totalValue.toLocaleString()}</span>
        </div>
      </div>
